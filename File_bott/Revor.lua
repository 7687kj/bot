...
if tonumber(msg.sender.user_id) == 450929011 then
msg.Name_Controller = 'مطور السورس '
msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) == 450929011 then
msg.Name_Controller = 'مطور السورس '
msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) == 450929011 then
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/IIlIlIlllI'}, },}}
...
data = {
{
{text = '- قناة السورس', url = 't.me/IIlIlIlllI'}, 
},
}
}
...
data = {
{
{text = 'Channel Source ،', url = 't.me/IIlIlIlllI'}, 
},
{
{text = 'Annotations Source', url = 'https://t.me/IIlIlIlllI'}, 
},
{
{text = 'Communication Source', url = 't.me/DaDdY_ibrhim69bot'}, 
},
{
{text = 'Developer Source !', url = 't.me/hottmail'}, 
},
}
}
return LuaTele.sendText(msg_chat_id,msg_id, [[
...
if text == (Redis:get(Revor.."Revor:Name:Bot") or "برهم") then
local NamesBot = (Redis:get(Revor.."Revor:Name:Bot") or "برهم")
local NameBots = {
"عمر "..NamesBot.. " شتريد؟",
"أჂ̤ أჂ̤ هياتني اني",
"موجود بس لتصيح",
...
local CmdStart = '*\n⌔︙أهلآ بك في بوت '..(Redis:get(Revor.."Revor:Name:Bot") or "برهم")..
